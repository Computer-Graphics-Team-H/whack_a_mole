    ...
    <div id="game">
      ...
      <Canvas>
        ...
        <Suspense fallback={null}>
          ...
          {/* <Diglett4 position={[0, 0, 0]} scale={[5, 5, 5]} />
          <Diglett5 position={[6, 0, 0]} scale={[5, 5, 5]} />
          <Diglett6 position={[-6, 0, 0]} scale={[5, 5, 5]} />
          <Diglett7 position={[0, 0, 0]} scale={[5, 5, 5]} />
          <Diglett8 position={[6, 0, 0]} scale={[5, 5, 5]} />
          <Diglett9 position={[-6, 0, 0]} scale={[5, 5, 5]} /> */}
